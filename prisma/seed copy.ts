...
async function main() {
        ...
        create: [
          {
            ...
            user_id: ''  // Will be updated after creation
          },
          {
  ...
  // Create sample agents with project relations
        ...
        create: [
          {
            project: {
              connect: {
                id: (await prisma.project.findFirst({ where: { name: "Cloud Migration Project" } }))!.id
              }
            }
          },
          {
            project: {
              connect: {
                id: (await prisma.project.findFirst({ where: { name: "Security Monitoring System" } }))!.id
              }
            }
          }
        ]
